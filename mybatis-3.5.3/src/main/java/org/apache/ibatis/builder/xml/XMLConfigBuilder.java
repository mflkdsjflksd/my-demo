...
public class XMLConfigBuilder extends BaseBuilder {
  ...
  public Configuration parse() {
    ...
    /**
     * @describe: parseConfiguration解析XML文件
     * parser.evalNode获取xml文件
     */
  ...
  private void parseConfiguration(XNode root) {
    try {
      ...
      /**
       * @describe: 设置settings 和默认值到configuration
       */
      ...
      /**
       * @describe: 解析databaseIdProvider
       * MyBatis能够执行不同的语句取决于你提供的数据库供应商。
       * 许多数据库供应商的支持是基于databaseId映射
       */
      databaseIdProviderElement(root.evalNode("databaseIdProvider"));
      /**
       * 解析typeHandlers 当MyBatis设置参数到PreparedStatement 或者从ResultSet
       * 结果集中取得值时，就会使用TypeHandler  来处理数据库类型与java 类型之间转换
       */
      typeHandlerElement(root.evalNode("typeHandlers"));
      /**
       * @describe: 解析xml文件 主要的crud操作都是在mappers中定义的
       */
